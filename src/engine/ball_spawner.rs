...
impl Plugin for BallSpawnerPlugin {
...
fn setup(
    ...
    let table_texture_handle = asset_server.load("table.png");
    // Calculate the dimensions of the table
    let table_width = 1137.75;
    let table_height = 642.5;
    
    commands.spawn(Camera2d);
    commands.spawn((Sprite {
        image: table_texture_handle.clone(),
    ...
    commands.spawn((
        ...
        for row in 1..=5 {
            ...
            for i in 0..row_count {
                ...
                let y_pos = row_start_y + i as f32 * spacing; 
